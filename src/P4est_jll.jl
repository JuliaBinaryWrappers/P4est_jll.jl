...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import P4est_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6b5a15aa-cf52-5330-8376-5e5d90283449"))
platforms = [Pkg.Artifacts.unpack_platform(e, "P4est", artifacts_toml) for e in artifacts["P4est"]]
...
if best_platform === nothing
    @debug("Unable to load P4est; unsupported platform $(triplet(platform_key_abi()))")
else
