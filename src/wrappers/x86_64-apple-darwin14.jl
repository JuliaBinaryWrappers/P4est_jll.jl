# Autogenerated wrapper script for P4est_jll for x86_64-apple-darwin14
...
const libp4est_splitpath = ["lib", "libp4est.dylib"]
...
const libp4est = "@rpath/libp4est-2.2.dylib"


# Relative path to `libsc`
const libsc_splitpath = ["lib", "libsc.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libsc = "@rpath/libsc-2.2.dylib"
